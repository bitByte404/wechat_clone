...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<ChatItemDataEntity>[] is M) {
      return data.map<ChatItemDataEntity>((Map<String, dynamic> e) =>
          ChatItemDataEntity.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (ChatItemDataEntity).toString(): ChatItemDataEntity.fromJson,
  };
